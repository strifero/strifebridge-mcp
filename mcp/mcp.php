...
function sbmcp_mcp_tools_call($id, $params) {
    ...
    switch ($name) {
        ...
        case 'update_option': return sbmcp_mcp_cb($id, sbmcp_update_option($json_req(['key' => $input['key'] ?? '', 'value' => $input['value'] ?? null, 'json' => $input['json'] ?? false])));
        case 'list_options':
